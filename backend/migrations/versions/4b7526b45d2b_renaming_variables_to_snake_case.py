"""renaming variables to snake_case

Revision ID: 4b7526b45d2b
Revises: 42c3e2690dc5
Create Date: 2026-01-06 23:39:36.036270
...
revision = '4b7526b45d2b'
down_revision = '42c3e2690dc5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('locations', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(batch_op.f('locations_publicId_key'), type_='unique')
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(batch_op.f('users_publicId_key'), type_='unique')
        batch_op.create_unique_constraint(None, ['public_id'])
        batch_op.drop_column('publicId')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('accessLevel', sa.INTEGER(), server_default=sa.text('1'), autoincrement=False, nullable=False))
        batch_op.add_column(sa.Column('publicId', sa.VARCHAR(length=50), autoincrement=False, nullable=False))
        batch_op.drop_constraint(None, type_='unique')
        batch_op.create_unique_constraint(batch_op.f('users_publicId_key'), ['publicId'], postgresql_nulls_not_distinct=False)
    ...
    with op.batch_alter_table('locations', schema=None) as batch_op:
        batch_op.add_column(sa.Column('publicId', sa.VARCHAR(length=50), autoincrement=False, nullable=False))
        batch_op.drop_constraint(None, type_='unique')
        batch_op.create_unique_constraint(batch_op.f('locations_publicId_key'), ['publicId'], postgresql_nulls_not_distinct=False)
        batch_op.drop_column('public_id')
